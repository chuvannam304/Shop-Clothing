<div class="page-title">
    <div>
        <h1>Thêm Màu sắc</h1>
        <p>Thêm màu sắc mới cho sản phẩm</p>
    </div>
...
<div class="card">
    ...
    <form action="index.php?controller=mausac&action=store" method="POST" class="admin-form">  
        <div class="form-group">
            <label for="TenMau">Tên màu <span class="required">*</span></label>
            <input type="text" id="TenMau" name="TenMau" placeholder="Ví dụ: Đen, Trắng, Đỏ..." required>
        </div>
        <div class="form-group">
            <label for="MaHex">Mã màu Hex</label>
            <div class="color-input-group">
                <input type="color" id="colorPicker" value="#000000">
                <input type="text" id="MaHex" name="MaHex" value="#000000" placeholder="#000000">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Lưu Màu sắc</button>
        </div>
    </form>
</div>
<script>
