<div class="page-title">
    <div>
        ...
        <p>Thêm nhãn hiệu mới cho sản phẩm</p>
    </div>
...
<div class="card">
    ...
    <form action="index.php?controller=nhanhieu&action=store" method="POST" enctype="multipart/form-data" class="admin-form">

        <div class="form-group">
            <label for="TenNhanHieu">Tên nhãn hiệu <span class="required">*</span></label>
            <input type="text" id="TenNhanHieu" name="TenNhanHieu" placeholder="Ví dụ: Nike, Adidas, Puma..." required>
        </div>

        <div class="form-group">
            <label for="Logo">Logo</label>
            <input type="file" id="Logo" name="Logo" accept=".jpg,.jpeg,.png,.webp">
            <small class="form-note">Chấp nhận JPG, JPEG, PNG, WEBP. Tối đa 5MB.</small>
        </div>

        <div class="form-group">
            <label for="MoTa">Mô tả</label>
            <textarea id="MoTa" name="MoTa" rows="4" placeholder="Nhập mô tả nhãn hiệu..."></textarea>
        </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary"><i class="fa-solid fa-floppy-disk"></i> Lưu Nhãn hiệu</button>
        </div>
